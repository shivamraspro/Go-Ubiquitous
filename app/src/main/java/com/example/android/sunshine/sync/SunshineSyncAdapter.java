...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements
    ...
    private void updateWatch() {
        ...
        // we'll query our contentProvider, as always
        Cursor cursor = context.getContentResolver().query(weatherUri, UPDATE_WATCH_PROJECTION,
                null, null, null);
        ...
        if(cursor.moveToFirst()) {
            ...
            PutDataMapRequest putDataMapRequest = PutDataMapRequest.create("/weather-today");
            putDataMapRequest.getDataMap().putInt("weatherId", weatherId);
            putDataMapRequest.getDataMap().putString("tempHigh", Utility.formatTemperature
                    (context, high));
    ...
    public void initializeGoogleApiClient() {
        Log.d("xxx", "sending weather data : ");
